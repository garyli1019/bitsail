...
public class DebeziumHelper {
  ...
  public static MySqlOffsetContext loadOffsetContext(MySqlConnectorConfig config, MysqlSplit split) {
    ...
    switch (split.getBeginOffset().getOffsetType()) {
      ...
      default:
        throw new BitSailException(MysqlCdcErrorCode.UNSUPPORTED_ERROR,
